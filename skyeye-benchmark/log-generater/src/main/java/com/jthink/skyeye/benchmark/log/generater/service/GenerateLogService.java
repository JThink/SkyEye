...
public class GenerateLogService {
    ...
    public void generateCoverLog() {
        ...
        LOGGER.info(ApiLog.buildApiLog(EventType.invoke_interface, "/log/realtime", "800002", 100, EventLog.MONITOR_STATUS_SUCCESS, "我是mock api成功日志").toString());
        // 生成中间件日志
        ...
        LOGGER.info(EventLog.buildEventLog(EventType.job_execute, "application_1477705439920_0545", 100, EventLog.MONITOR_STATUS_SUCCESS, "我是mock job exec成功日志").toString());
        // 生成第三方日志
