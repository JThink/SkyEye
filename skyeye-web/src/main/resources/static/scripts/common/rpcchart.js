...
define(['jquery', 'echarts', 'common/util', 'underscore'], function ($, echarts, util, _) {
    ...
    var generateSuccFailData = function (params, resData, name) {
        var data = {};
        data[name] = {};
        var line, time, succ, fail, max, min, average;
        ...
        var sf;
        var succArr = [], failArr = [], maxArr = [], averageArr = [], minArr = [];
        ...
        for (var i = 0; i < timeArr.length; i++) {
            ...
            maxArr.push({name: time, value: sf.max == null ? 0 : sf.max});
            averageArr.push({name: time, value: sf.average == null ? 0 : sf.average});
            minArr.push({name: time, value: sf.min == null ? 0 : sf.min});
        ...
        var series = [
            ...
            {
                name: "平均值", data: averageArr,
                // stack: '总量',
                type: "line", smooth: true,
                symbol: "none", barMinHeight: 1,
                areaStyle: {
                    normal: {
                        // color: colorPalette[1],平均值
                        opacity: 0.3
                    }
                }
            }
