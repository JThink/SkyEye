...
case "${1:-''}" in
    ...
    -c|--clean)
        # compile the base project
        echo 'start to clean skyeye-base...'
        cd $base_dir
        gradle clean
        echo 'finish clean skyeye-base...'

        # compile the data project
        echo 'start to clean skyeye-data...'
        cd $data_dir
        gradle clean
        echo 'finish clean skyeye-data...'

        # compile the trace project
        echo 'start to clean skyeye-trace...'
        cd $trace_dir
        gradle clean
        echo 'finish clean skyeye-trace...'

        # compile the client project
        echo 'start to clean skyeye-client...'
        cd $client_dir
        gradle clean
        echo 'finish clean skyeye-client...'

        # compile the alarm project
        echo 'start to clean skyeye-alarm...'
        cd $alarm_dir
        gradle clean
        echo 'finish clean skyeye-alarm...'

        # compile the collector project
        echo 'start to clean skyeye-collector...'
        cd $collector_dir
        gradle clean
        echo 'finish clean skyeye-collector...'

        # compile the monitor project
        echo 'start to clean skyeye-monitor...'
        cd $monitor_dir
        gradle clean
        echo 'finish clean skyeye-monitor...'

        # compile the web project
        echo 'start to clean skyeye-web...'
        cd $web_dir
        gradle clean
        echo 'finish clean skyeye-web...'
        ;;
esac
